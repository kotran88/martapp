...
var AddshopingPage = /** @class */ (function () {
    ...
    AddshopingPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__ionic_native_speech_recognition__["a" /* SpeechRecognition */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ToastController */]])
    ], AddshopingPage);
...
var ViewshoppinglistPage = /** @class */ (function () {
    ...
    ViewshoppinglistPage.prototype.released = function (v) {
    ...
    ViewshoppinglistPage.prototype.insertData1 = function () {
        this.flag = true;
    };
    /*삭제*/
...
var MartlistPage = /** @class */ (function () {
    ...
    MartlistPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* ModalController */]])
    ], MartlistPage);
    return MartlistPage;
}());
    ...
    MartinfoPage.prototype.favorite = function (a, idx) {
        ...
        if (flag != true) {
            this.firemain.child("users").child(this.userId).child("favorite").once("value", function (sn) {
                ...
                if (_this.favoriteList.length < 20) {
                ...
                else if (_this.favoriteList.length >= 20) {
