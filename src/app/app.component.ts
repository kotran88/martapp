...
import { Platform, App, AlertController, ModalController } from 'ionic-angular';
...
export class MyApp {
  ...
  constructor(public screen: ScreenOrientation, public alertCtrl: AlertController, public app: App, platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen,public modal: ModalController) {
    platform.ready().then(() => {
      ...
      platform.registerBackButtonAction(() => {
        ...
        if (activeView != null) {
          ...
          if (nav.getActive().component.name == "HomePage") {
            ...
            let modal = this.modal.create(ExitAppPage);
